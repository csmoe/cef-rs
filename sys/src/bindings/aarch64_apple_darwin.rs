...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _cef_window_info_t"][::std::mem::size_of::<_cef_window_info_t>() - 88usize];
    ...
    ["Offset of field: _cef_window_info_t::hidden"]
        [::std::mem::offset_of!(_cef_window_info_t, hidden) - 40usize];
    ["Offset of field: _cef_window_info_t::parent_view"]
        [::std::mem::offset_of!(_cef_window_info_t, parent_view) - 48usize];
    ["Offset of field: _cef_window_info_t::windowless_rendering_enabled"]
        [::std::mem::offset_of!(_cef_window_info_t, windowless_rendering_enabled) - 56usize];
    ["Offset of field: _cef_window_info_t::shared_texture_enabled"]
        [::std::mem::offset_of!(_cef_window_info_t, shared_texture_enabled) - 60usize];
    ["Offset of field: _cef_window_info_t::external_begin_frame_enabled"]
        [::std::mem::offset_of!(_cef_window_info_t, external_begin_frame_enabled) - 64usize];
    ["Offset of field: _cef_window_info_t::view"]
        [::std::mem::offset_of!(_cef_window_info_t, view) - 72usize];
    ["Offset of field: _cef_window_info_t::runtime_style"]
        [::std::mem::offset_of!(_cef_window_info_t, runtime_style) - 80usize];
};
#[doc = "\n Class representing window information.\n"]
