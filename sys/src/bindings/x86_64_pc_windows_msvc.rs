...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _cef_window_info_t"][::std::mem::size_of::<_cef_window_info_t>() - 104usize];
    ["Alignment of _cef_window_info_t"][::std::mem::align_of::<_cef_window_info_t>() - 8usize];
    ["Offset of field: _cef_window_info_t::ex_style"]
        [::std::mem::offset_of!(_cef_window_info_t, ex_style) - 0usize];
    ...
    ["Offset of field: _cef_window_info_t::style"]
        [::std::mem::offset_of!(_cef_window_info_t, style) - 32usize];
    ["Offset of field: _cef_window_info_t::bounds"]
        [::std::mem::offset_of!(_cef_window_info_t, bounds) - 36usize];
    ["Offset of field: _cef_window_info_t::parent_window"]
        [::std::mem::offset_of!(_cef_window_info_t, parent_window) - 56usize];
    ["Offset of field: _cef_window_info_t::menu"]
        [::std::mem::offset_of!(_cef_window_info_t, menu) - 64usize];
    ["Offset of field: _cef_window_info_t::windowless_rendering_enabled"]
        [::std::mem::offset_of!(_cef_window_info_t, windowless_rendering_enabled) - 72usize];
    ["Offset of field: _cef_window_info_t::shared_texture_enabled"]
        [::std::mem::offset_of!(_cef_window_info_t, shared_texture_enabled) - 76usize];
    ["Offset of field: _cef_window_info_t::external_begin_frame_enabled"]
        [::std::mem::offset_of!(_cef_window_info_t, external_begin_frame_enabled) - 80usize];
    ["Offset of field: _cef_window_info_t::window"]
        [::std::mem::offset_of!(_cef_window_info_t, window) - 88usize];
    ["Offset of field: _cef_window_info_t::runtime_style"]
        [::std::mem::offset_of!(_cef_window_info_t, runtime_style) - 96usize];
};
#[doc = "\n Structure representing window information.\n"]
...
pub enum cef_permission_request_types_t {
    ...
    CEF_PERMISSION_TYPE_HAND_TRACKING = 1024,
    CEF_PERMISSION_TYPE_IDENTITY_PROVIDER = 2048,
    CEF_PERMISSION_TYPE_IDLE_DETECTION = 4096,
    CEF_PERMISSION_TYPE_MIC_STREAM = 8192,
    CEF_PERMISSION_TYPE_MIDI_SYSEX = 16384,
    CEF_PERMISSION_TYPE_MULTIPLE_DOWNLOADS = 32768,
    CEF_PERMISSION_TYPE_NOTIFICATIONS = 65536,
    CEF_PERMISSION_TYPE_KEYBOARD_LOCK = 131072,
    CEF_PERMISSION_TYPE_POINTER_LOCK = 262144,
    CEF_PERMISSION_TYPE_PROTECTED_MEDIA_IDENTIFIER = 524288,
    CEF_PERMISSION_TYPE_REGISTER_PROTOCOL_HANDLER = 1048576,
    CEF_PERMISSION_TYPE_STORAGE_ACCESS = 2097152,
    CEF_PERMISSION_TYPE_VR_SESSION = 4194304,
    CEF_PERMISSION_TYPE_WEB_APP_INSTALLATION = 8388608,
    CEF_PERMISSION_TYPE_WINDOW_MANAGEMENT = 16777216,
    CEF_PERMISSION_TYPE_FILE_SYSTEM_ACCESS = 33554432,
}
#[repr(i32)]
#[non_exhaustive]
...
pub struct _cef_window_t {
    ...
    pub get_window_handle:
        ::std::option::Option<unsafe extern "C" fn(self_: *mut _cef_window_t) -> HWND>,
